...
const Carousel = () => {
  return (
      ...
      <Image width={1920} height={1080} src="/c1.jpg" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/>
    ...
    //             <Image width={100} height={100} src="/c1.jpg" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/>
    //         </div>
    //         {/* <!-- Item 3 --> */}
    //         <div className=" duration-700 ease-in-out" data-carousel-item>
    //             <Image width={500} height={500} src="/c1.jpg" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/>
    //         </div>
    //         {/* <!-- Item 4 --> */}
    //         <div className=" duration-700 ease-in-out" data-carousel-item>
    //             <Image width={100} height={100} src="/c1.jpg" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/>
